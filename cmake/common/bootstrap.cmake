...
string(JSON _installerAppId ERROR_VARIABLE _installerAppId_error GET ${buildspec} platformConfig windows installerAppId)
...
if(_displayName_error)
  ...
  string(REPLACE "'" "''" PLUGIN_DISPLAY_NAME "${_displayName}")
endif()

if(_installerAppId_error)
  set(UUID_APP "00000000-0000-0000-0000-000000000000")
else()
  set(UUID_APP ${_installerAppId})
endif()
